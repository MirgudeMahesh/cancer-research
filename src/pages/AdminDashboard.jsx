...
const AdminDashboard = () => {
    ...
    const fetchPractitioners = async () => {
        try {
            const response = await fetch('https://cancer-research-backend.onrender.com/api/admin/practitioners');
    ...
    const handleApprove = async (id) => {
        ...
        setProcessingId(id);
        try {
            const response = await fetch(`https://cancer-research-backend.onrender.com/api/admin/practitioners/${id}/approve`, { method: 'POST' });
            const data = await response.json();
            if (data.success) {
                alert(data.message);
                fetchPractitioners();
    ...
    const handleReject = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://cancer-research-backend.onrender.com/api/admin/practitioners/${id}/reject`, {
                method: 'POST',
